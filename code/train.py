...
def train_fn(env_name, num_envs, distribution_mode, num_levels, start_level, timesteps_per_proc, is_test_worker=False, log_dir='/tmp/procgen', comm=None):
    ...
    eval_venv = ProcgenEnv(num_envs=num_envs, env_name=env_name, num_levels=500, start_level=0, distribution_mode=distribution_mode)
    ...
    conv_fn = lambda x: build_model(x, depths=[16,32,32], bn=True, emb_size=256)
...
def main():
    ...
    parser.add_argument('--log_dir', type=str, default='logs0/')
